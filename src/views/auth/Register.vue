            ...
            <div class="border rounded-lg overflow-hidden">
                ...
                <div class="p-4">
                    <form @submit.prevent="register">
                        ...
                        <div class="mb-5">
                            <label for="email" class="text-xs uppercase font-medium block mb-2">Email</label>
                            <input 
                                type="email" 
                                name="email" 
                                id="email" 
                        ...
                        <div class="mb-5">
                            <label for="password" class="text-xs uppercase font-medium block mb-2">Password</label>
                            <input 
                                type="password" 
                                name="password" 
                                id="password" 
                        ...
                        <div class="mb-5">
                            <label for="password_confirmation" class="text-xs uppercase font-medium block mb-2">Password Confirmation</label>
                            <input 
                                type="password" 
